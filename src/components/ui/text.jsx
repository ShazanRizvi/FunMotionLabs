...
function AppleHelloEnglishEffect({
    ...
    const getInitialState = () => {
        if (isCanvas) return animateProps
        return autoPlay ? initialProps : animateProps
    }

    const getAnimateState = () => {
        if (isCanvas) return animateProps
        return autoPlay ? animateProps : animateProps
    }
    ...
    return (
        ...
        >
            ...
            <motion.path
                ...
                transition={{
                    duration: isCanvas ? 0 : calc(0.8),
                    ease: "easeInOut",
                    opacity: { duration: isCanvas ? 0 : 0.4 },
                }}
            />
            ...
            <motion.path
                ...
                animate={getAnimateState()}
                transition={{
                    duration: isCanvas ? 0 : calc(2.8),
                    ease: "easeInOut",
                    delay: isCanvas ? 0 : calc(0.7),
                    opacity: {
                        duration: isCanvas ? 0 : 0.7,
                        delay: isCanvas ? 0 : calc(0.7),
                    },
                }}
...
export default function AppleHelloEffect(props: AppleHelloProps) {
    const {
        duration = 1,
        strokeWidth = 14.8883,
        strokeColor = "#000000",
...
addPropertyControls(AppleHelloEffect, {
    size: {
